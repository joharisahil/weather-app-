class SearchWeatherModel {
  ...
  SearchWeatherModel({this.request, this.location, this.current});
...
class Location {
  ...
  Location({this.name, this.country, this.region, this.lat, this.lon, this.timezoneId, this.localtime, this.localtimeEpoch, this.utcOffset});
