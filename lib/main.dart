...
import 'package:demo_application/screens/search_screen.dart';
          ...
          actions: [
            ...
            IconButton(
                onPressed: () async {
                  ...
                  // http.Response res = await http.get(Uri.parse("${searchWeatherUrl}bareilly"));
                      ...
                      if (snapshot.hasData) {
                        ...
                        return SingleChildScrollView(
                          ...
                          child: Column(
                            ...
                            children: [
                              "${data.name}".text.uppercase.fontFamily("poppins_bold").size(32).letterSpacing(3).color(theme.primaryColor).make(),
                              Row(
                              ...
                              Row(
                                ...
                                children: [
                                  TextButton.icon(onPressed: null, icon: Icon(Icons.expand_less_rounded, color: theme.iconTheme.color), label: "${data.main!.tempMax}$degree".text.color(theme.iconTheme.color).make()),
                                  TextButton.icon(onPressed: null, icon: Icon(Icons.expand_more_rounded, color: theme.iconTheme.color), label: "${data.main!.tempMin}$degree".text.color(theme.iconTheme.color).make())
                                ],
                              ),
                              10.heightBox,
                              Row(
                                    ...
                                    child: Container(
                                      ...
                                      child: Row(
                                        ...
                                        children: [
                                          ...
                                          Expanded(
                                            child: TextButton.icon(onPressed: null, icon: Image.asset("assets/weather/50n.png", width: 40), label: "26$degree".text.size(16).color(theme.primaryColor).make()),
                                          ),
                                          RichText(
                                            text: TextSpan(
                                              children: [
